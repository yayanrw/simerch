          ...
          <div class="box box-primary">
            <table class="table table-striped table-hover text-center" >
              ...
              if (isset($_GET['filter'])) {
                ...
                $arrayData = $db->tampilData3('transaksi', 'tanggal');
              }
              $no=1;
              if ($arrayData) {
                foreach ($arrayData as $data) {
                  ...
                  <tr>
                    <td><?php echo $no++; ?></td>
                      <td><a href="user_profile.php?id_user=<?php echo  $data['nim'] ?>"><i class="fa fa-user"></i> <?php echo $db->tampilNama('user', 'nim', $data['nim']); ?></a></td>
                      <td><?php echo $mysqldate ?></td>
                      <td><a href="transaksi_detail.php?id=<?php echo urlencode($data['tanggal']); ?>" class="btn btn-info btn-sm"><i class="fa fa-eye"></i> Detail</a></td>
                      </tr>
                      <?php } }?>
                    </table>
                  </div>
