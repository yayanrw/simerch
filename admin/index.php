    ...
    <section class="content">
     <div class="callout callout-info">
      <div class="callout-body">
        <h2>User dengan pembelian terbanyak</h2>
        <div id="list-item" class="owl-carousel owl-theme">
          <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3"></div>
          <?php 
          $arrayData = $db->tampilDataLimit('user', 'pengeluaran', '5');
          if ($arrayData) {
            foreach ($arrayData as $data) {
             ?>
             <div class="item"><center>
              <a href="user_profile.php?id_user=<?php echo  $data['nim'] ?>"><img src="../images/user/<?php echo $data['foto']; ?>" class="img-responsive" style="height: 150px;">
              <h4><?php echo $data['nama']; ?></h4></a></center>
            </div>
            <?php }} ?>
          </div>
        </div>
