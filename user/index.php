        ...
        <section class="content">
          ...
          <div class="callout callout-info">
            <div class="callout-body">
              <h2>Hot Items</h2>
              <div id="list-item" class="owl-carousel owl-theme">
                <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3"></div>
                <div class="item">
                  <img style="height: 150px" src="../images/merch/1.png" class="img-responsive">
                </div>
                <div class="item">
                  <img style="height: 150px" src="../images/merch/kaos.png" class="img-responsive">
                </div>
                <div class="item">
                  <img style="height: 150px" src="../images/merch/hms.png" class="img-responsive">
                </div>
                <div class="item">
                  <img style="height: 150px" src="../images/merch/hmm.png" class="img-responsive">
                </div>
                <div class="item">
                  <img style="height: 150px" src="../images/merch/igkunci.jpg" class="img-responsive">
                </div>
            </div>
          </div></div>
        </section>
