      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <div class="box box-danger">
            <div class="box-body">
              <p>kedai merchandise merupakan sebuah webite khusus yang menyediakan berbagai merchndise khas polinema.dengan sise penjualan yang praktis dan efisien. websiste ini ditujukan untuk seluruh warga polinema.serta sebagai sarana menjual hasil kreatifitas mahasiswa serta sebagai pmbeljaran bisnis untuk mahasiswa . </p>
            </div>
          </div>
        </section>
      </div>
